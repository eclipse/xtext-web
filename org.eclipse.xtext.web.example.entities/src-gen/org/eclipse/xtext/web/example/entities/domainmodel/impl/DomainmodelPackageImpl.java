...
import org.eclipse.xtext.web.example.entities.domainmodel.DomainmodelFactory;
...
public class DomainmodelPackageImpl extends EPackageImpl implements DomainmodelPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getEntities_ImportSection(), theXtypePackage.getXImportSection(), null, "importSection", null, 0, 1, Entities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEntities_Elements(), this.getAbstractElement(), null, "elements", null, 0, -1, Entities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
