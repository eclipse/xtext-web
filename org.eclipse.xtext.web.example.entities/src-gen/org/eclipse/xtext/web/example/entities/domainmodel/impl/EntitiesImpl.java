...
public class EntitiesImpl extends MinimalEObjectImpl.Container implements Entities
{
  ...
  {
    return DomainmodelPackage.Literals.ENTITIES;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, DomainmodelPackage.ENTITIES__ELEMENTS);
    }
    return elements;
  }
